    ...
    public static class AmplifyOcclusionCommon
    {
        ...
        public static Material CreateMaterialWithShaderName(string aShaderName, bool aThroughErrorMsg)
        {
            if (aShaderName == "Hidden/Amplify Occlusion/Occlusion")
            {
                ...
                {
                    OcclusionMaterial = new Material(ModResources.Shader(ModAssetBundles.AMPLIFY_OCCLUSION, "Occlusion"));
                }
            ...
            if (aShaderName == "Hidden/Amplify Occlusion/Blur")
            {
                if (!BlurMaterial)
                {
                    BlurMaterial = new Material(ModResources.Shader(ModAssetBundles.AMPLIFY_OCCLUSION, "Blur"));
                }
                return BlurMaterial;
            }
            if (aShaderName == "Hidden/Amplify Occlusion/Apply")
            {
                if (!ApplyMaterial)
                {
                    ApplyMaterial = new Material(ModResources.Shader(ModAssetBundles.AMPLIFY_OCCLUSION, "Apply"));
                }
