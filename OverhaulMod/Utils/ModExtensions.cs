...
namespace OverhaulMod.Utils
{
    internal static class ModExtensions
    {
        ...
        public static bool CanBeReverted(this UpgradeDescription upgradeDescription)
        {
            ...
            Dictionary<UpgradeType, int> dictionary = GameDataManager.Instance.GetPlayerUpgradeDictionary();
            if (!UpgradeModesManager.Instance.CanRevertUpgrade(upgradeDescription.UpgradeType, upgradeDescription.Level) || dictionary.IsNullOrEmpty() || upgradeDescription.IsRepeatable || !dictionary.ContainsKey(upgradeDescription.UpgradeType))
                return false;
