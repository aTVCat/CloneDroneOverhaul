...
{
    public class UIInviteToLobby : V3_ModHUDBase
    {
        public static UIInviteToLobby Instance;
        ...
        private void Update()
        {
            ...
            if (isDuel)
            {
                duelUI.SetActive(GameFlow1v1Manager.Instance != null && (GameFlow1v1Manager.Instance.IsProgress(MatchProgress1v1.WaitingForOpponent) || GameFlow1v1Manager.Instance.IsProgress(MatchProgress1v1.NotStarted)), true);
            }
        ...
        internal class LBSUI
        {
            ...
            public void SetActive(bool value)
            {
                ...
                if (value)
                {
                    gameObject.GetComponent<Image>().sprite = OverhaulCacheAndGarbageController.GetCached<Sprite>("LBSInviteScreenBG_" + Random.Range(1, 5).ToString());
                    ...
                    CloneDroneOverhaul.Utilities.Coroutines.LerpImageColor(Background, new Color(0.75f, 0.75f, 0.75f, 1), 0.5f);
                    RefreshLevels();
            ...
            private IEnumerator startLoadingLevelsCoroutine()
            {
                ...
                moddedObjectMain.GetObjectFromList<RectTransform>(13).gameObject.SetActive(false);
                CloneDroneOverhaul.Utilities.Coroutines.LerpImageColor(Background, new Color(0.5f, 0.5f, 0.5f, 1), 0.5f);

                yield return new WaitUntil(() => CharacterTracker.Instance.GetPlayer() != null);
                CloneDroneOverhaul.Utilities.Coroutines.LerpImageColor(Background, new Color(0.5f, 0.5f, 0.5f, 0), 0.5f);
            ...
            public class BattleRoyaleLevelDisplay : MonoBehaviour
            {
                ...
                public BattleRoyaleLevelDisplay SetUP(LevelDescription desc, BetterToggleGroup group)
                {
                    ...
                    CloneDroneOverhaul.Utilities.Coroutines.LoadWorkshopImage(desc.WorkshopItem.PreviewURL, desc.WorkshopItem.WorkshopItemID.ToString(), delegate (Sprite sp)
                    {
        ...
        internal class DuelUI
        {
            ...
            {
                BaseUtils.CopyToClipboard(MultiplayerMatchmakingManager.Instance.GetLastInviteCode(), true);
            }
        ...
        internal class CoopUI
        {
            ...
            {
                Background.sprite = UIInviteToLobby.Instance.CoopEndlessImage;
                if (isCoopChallenge)
                {
                    Background.sprite = UIInviteToLobby.Instance.CoopChallengeImage;
                }
                Background.color = Color.black;
                CloneDroneOverhaul.Utilities.Coroutines.LerpImageColor(Background, new Color(1, 1, 1, 1), 0.5f);
            ...
            public void OnStartGameClicked()
            {
                ...
                CloneDroneOverhaul.Utilities.Coroutines.LerpImageColor(Background, Color.clear, 0.25f, Hide);
            }
