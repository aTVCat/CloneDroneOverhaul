...
namespace CloneDroneOverhaul.V3Tests.HUD
{
    public class UIVersionLabel : V3_ModHUDBase
    {
        ...
        private void Update()
        {
            _versionLabel.gameObject.SetActive(_showVersion && !PhotoManager.Instance.IsInPhotoMode() && !CutSceneManager.Instance.IsInCutscene() && !GameModeManager.IsInLevelEditor() && !Modules.MiscEffectsManager.IsUIHidden);
