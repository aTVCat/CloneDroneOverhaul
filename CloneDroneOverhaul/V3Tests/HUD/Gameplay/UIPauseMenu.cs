...
namespace CloneDroneOverhaul.V3Tests.HUD
{
    public class UIPauseMenu : V3_ModHUDBase
    {
        ...
        private void Awake()
        {
            ...
            CDOSettings.onClick.AddListener(UISettings.GetInstance<UISettings>().Show);
        ...
        public void Hide()
        {
            ...
            {
                UISettings.GetInstance<UISettings>().Hide();
            }
        ...
        private void refreshWorkshop()
        {
            ...
            if (item != null)
            {
                ...
                Coroutines.LoadWorkshopImage(item.PreviewURL, item.WorkshopItemID.ToString(), delegate (Sprite spr)
                {
