        ...
        public class ItemDetailsUI : MonoBehaviour
        {
            ...
            public void Initialize(UIWorkshopBrowser browser)
            {
                ...
                _playButton.onClick.AddListener(delegate ()
                {
                    ...
                    {
                        V3Tests.HUD.TransitionAction act = new V3Tests.HUD.TransitionAction
                        {
                            Type = V3Tests.HUD.ETranstionType.Method,
                            Action = delegate
                            {
                        ...
                        V3Tests.HUD.SceneTransitionController.StartTranstion(act, "Spawning level...", string.Empty, false);
                        return;
                    }
                    else
                    {
                        if (_browser.GetCurrentLevelType() == 0)
                        {
                            ...
                            _goToGameMode.GetComponent<Button>().onClick.AddListener(delegate ()
                            {
                                ...
                                V3Tests.HUD.SceneTransitionController.StartTranstion(act, "Starting Endless mode...", string.Empty, false);
                            });
