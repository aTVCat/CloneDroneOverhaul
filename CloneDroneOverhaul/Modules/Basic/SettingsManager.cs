...
namespace CloneDroneOverhaul.Modules
{
    public class OverhaulSettingsManager : ModuleBase
    {
        ...
        public override void Start()
        {
            ...
            AddSetting(SettingEntry.NewSetting<LightLimit>("Light limit", "Sets the limit of visible point lights", "Graphics", "Settings", 1, null, new SettingEntry.UIValueSettings() { DropdownEnumType = typeof(LightLimit) }));
            AddSetting(SettingEntry.NewSetting<bool>("Vignette", "Shades screen edges", "Graphics", "Additions", true));
