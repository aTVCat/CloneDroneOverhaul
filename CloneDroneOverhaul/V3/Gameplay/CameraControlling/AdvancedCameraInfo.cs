...
namespace CloneDroneOverhaul.V3.Gameplay
{
    public class RobotAdvancedCameraController : MonoBehaviour
    {
        ...
        private bool _justShowingModels;
        ...
        {
            HideModels(null);
            _justShowingModels = false;
        }

        public void TryHideModels()
        {
            if(!_justShowingModels) UpdateModelsAndCamera(false, true);
        }
