...
namespace CloneDroneOverhaul.V3.Gameplay
{
    public class OverhaulGraphicsController : V3_ModControllerBase
    {
        ...
        public static EAntialiasingLevel AntiAliasingLevel = EAntialiasingLevel.Off;
        ...
        public static void Simulate_SwordBlock(in Vector3 position, in bool isFire)
        {
            ...
            V3.RobotShortInformation info = statistic.PlayerRobotInformation;
        ...
        public static (EShadowBias, EShadowBias) ShadowsBias;
        public static (EShadowDistance, EShadowDistance) ShadowsDistance;
        public static (EShadowResolution, EShadowResolution) ShadowsResolution;
        ...
        public override void OnSettingRefreshed(in string settingName, in object value)
        {
            ...
            {
                AntiAliasingLevel = (EAntialiasingLevel)(int)value;
                switch (AntiAliasingLevel)
                {
                    case EAntialiasingLevel.Off:
                        QualitySettings.antiAliasing = 0;
                        break;
                    case EAntialiasingLevel.X2:
                        QualitySettings.antiAliasing = 2;
                        break;
                    case EAntialiasingLevel.X4:
                        QualitySettings.antiAliasing = 4;
                        break;
                    case EAntialiasingLevel.X8:
        ...
        public static void SetParameterValue(in EGraphicsParameterNames parameter, in object value, in bool overrideSetting)
        {
            switch (parameter)
            {
                ...
                case EGraphicsParameterNames.ShadowsBias:
                    ...
                    if (overrideSetting)
                    {
                        ShadowsBias.Item1 = (EShadowBias)value;
                    }
                    else
                    {
                        ShadowsBias.Item2 = (EShadowBias)value;
                    }
                ...
                case EGraphicsParameterNames.ShadowsDistance:
                    ...
                    if (overrideSetting)
                    {
                        ShadowsDistance.Item1 = (EShadowDistance)value;
                    }
                    else
                    {
                        ShadowsDistance.Item2 = (EShadowDistance)value;
                    }
                ...
                case EGraphicsParameterNames.ShadowsResolution:
                    ...
                    if (overrideSetting)
                    {
                        ShadowsResolution.Item1 = (EShadowResolution)value;
                    }
                    else
                    {
                        ShadowsResolution.Item2 = (EShadowResolution)value;
                    }
        ...
        public static void RefreshGraphics()
        {
            ...
            EShadowDistance shadowDistance = (OverrideSettings ? ShadowsDistance.Item1 : ShadowsDistance.Item2);
            switch (shadowDistance)
            {
                case EShadowDistance.Default:
                    QualitySettings.shadowDistance = 300;
                    break;

                case EShadowDistance.VeryLow:
                    QualitySettings.shadowDistance = 100;
                    break;

                case EShadowDistance.Low:
                    QualitySettings.shadowDistance = 200;
                    break;

                case EShadowDistance.High:
                    QualitySettings.shadowDistance = 500;
                    break;

                case EShadowDistance.VeryHigh:
                    QualitySettings.shadowDistance = 750;
                    break;

                case EShadowDistance.ExtremlyHigh:
        ...
        public static void PatchLight(in Light light, in bool enableShadows, in bool patchSBias = true)
        {
            EShadowResolution enumRes = (OverrideSettings ? ShadowsResolution.Item1 : ShadowsResolution.Item2);
            switch (enumRes)
            {
                ...
                case EShadowResolution.Default:
                ...
                case EShadowResolution.ExtremlyHigh:
            ...
            if (patchSBias)
            {
                EShadowBias shadowBias = (OverrideSettings ? ShadowsBias.Item1 : ShadowsBias.Item2);
                switch (shadowBias)
                {
                    case EShadowBias.Minimum:
                        light.shadowBias = 0;
                        break;

                    case EShadowBias.Low:
                        light.shadowBias = 0.2f;
                        break;

                    case EShadowBias.Default:
                        light.shadowBias = 1f;
                        break;
