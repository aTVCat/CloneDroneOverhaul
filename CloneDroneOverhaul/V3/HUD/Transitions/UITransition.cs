...
namespace CloneDroneOverhaul.V3.HUD
{
    public class TransitionUI : BoltGlobalEventListenerSingleton<TransitionUI>
    {
        ...
        {
            ModdedObject mObj = Instantiate(OverhaulCacheAndGarbageController.GetCached<GameObject>("UI_TransitionScreen")).GetComponent<ModdedObject>();
        ...
        public void Show()
        {
            ...
            OverhaulMain.Timer.CompleteInTime(delegate
            {
                ...
                if (Action.Type == ETranstionType.Method)
                {
                    Action.Action();
                    OverhaulMain.Timer.CompleteInTime(delegate
                    {
                ...
                else if (Action.Type == ETranstionType.SceneSwitch)
                {
