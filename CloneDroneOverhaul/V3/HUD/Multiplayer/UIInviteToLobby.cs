    ...
    public class UIInviteToLobby : V3_ModHUDBase
    {
        ...
        internal class LBSUI
        {
            ...
            public void SetActive(bool value)
            {
                ...
                if (value)
                {
                    ...
                    V3.Utilities.Coroutines.LerpImageColor(Background, new Color(0.75f, 0.75f, 0.75f, 1), 0.5f);
                    RefreshLevels();
            ...
            private IEnumerator startLoadingLevelsCoroutine()
            {
                ...
                moddedObjectMain.GetObjectFromList<RectTransform>(13).gameObject.SetActive(false);
                CloneDroneOverhaul.V3.Utilities.Coroutines.LerpImageColor(Background, new Color(0.5f, 0.5f, 0.5f, 1), 0.5f);

                yield return new WaitUntil(() => CharacterTracker.Instance.GetPlayer() != null);
                CloneDroneOverhaul.V3.Utilities.Coroutines.LerpImageColor(Background, new Color(0.5f, 0.5f, 0.5f, 0), 0.5f);
            ...
            public class BattleRoyaleLevelDisplay : MonoBehaviour
            {
                ...
                public BattleRoyaleLevelDisplay SetUP(LevelDescription desc, BetterToggleGroup group)
                {
                    ...
                    CloneDroneOverhaul.V3.Utilities.Coroutines.LoadWorkshopImage(desc.WorkshopItem.PreviewURL, desc.WorkshopItem.WorkshopItemID.ToString(), delegate (Sprite sp)
                    {
        ...
        internal class CoopUI
        {
            ...
            public void SetActive(bool val, bool isCoopChallenge = false)
            {
                ...
                Background.color = Color.black;
                CloneDroneOverhaul.V3.Utilities.Coroutines.LerpImageColor(Background, new Color(1, 1, 1, 1), 0.5f);
            ...
            public void OnStartGameClicked()
            {
                ...
                CloneDroneOverhaul.V3.Utilities.Coroutines.LerpImageColor(Background, Color.clear, 0.25f, Hide);
            }
