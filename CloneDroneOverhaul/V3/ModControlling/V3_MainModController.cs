...
namespace CloneDroneOverhaul.V3.Base
{
    ...
    public class V3_MainModController : V3_ModControllerBase
    {
        ...
        /// <summary>
        /// The canvas of the mod UI
        /// </summary>
        public static Canvas ModGUICanvas { get; private set; }
        ...
        /// <summary>
        /// Assets are being asynchronously loaded on game first start. Returns<b> true </b> if all assets were loaded.
        /// </summary>
        ...
        public static void Initialize()
        {
            ...
            ModSettingsController.Initialize();
            ...
            OverhaulMain.Timer = AddManager<DelegateTimer>("DelegateScheduler");
            HotkeysModule hKeys = AddManager<HotkeysModule>("HotkeysController");
            ...
            Gameplay.WorldGUIs wGUIs = AddManager<Gameplay.WorldGUIs>("WorldGUIs");
            Graphics.CameraRollController cameraRoll = AddManager<Graphics.CameraRollController>("CameraRollingController");
            Localization.LocalizationController localizationController = AddManager<Localization.LocalizationController>("LocalizationController");

            

            GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(ModLibrary.AssetLoader.GetObjectFromFile("cdo_rw_stuff", "CDO_RW_UI"));
            gameObject.name = "CloneDroneOverhaulUI";
            ModdedObject modHUDModdedObject = gameObject.GetComponent<ModdedObject>();
            ...
            HUD.V3_ModHUDBase.AddHUD<HUD.UIModSettings>(modHUDModdedObject.GetObjectFromList<ModdedObject>(21));
            HUD.V3_ModHUDBase.AddHUD<UILocalizationEditor>(modHUDModdedObject.GetObjectFromList<ModdedObject>(2));
        ...
        {
            V3.HUD.TransitionAction t = new V3.HUD.TransitionAction
            {
                Type = V3.HUD.ETranstionType.SceneSwitch,
                SceneName = "Gameplay",
                HideOnComplete = true
            };
            V3.HUD.SceneTransitionController.StartTranstion(t, "Loading...", "This may take a while...", true);
        }
