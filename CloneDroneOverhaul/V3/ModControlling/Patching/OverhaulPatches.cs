...
namespace CloneDroneOverhaul
{
    internal class OverhaulSepratedPatchMethods
    {
        ...
        {
            OverhaulMain.Timer.CompleteInTime(delegate
            {
                ...
                {
                    //UISettings_OLD.GetInstance<UISettings_OLD>().ShowWithOpenedPage("Graphics", "Settings");
                });
                }
            }, 0.05f, true);
        }
    ...
    public class OverhaulUIPatches
    {
        ...
        private static bool GameUIRoot_RefreshCursorEnabled_Prefix()
        {
            try
            {
                if (UICrashScreen.GetInstance<UICrashScreen>().gameObject.activeInHierarchy || UIInviteToLobby.GetInstance<UIInviteToLobby>().ShallCursorBeActive() ||
                        UIMultiplayer.GetInstance<UIMultiplayer>().BRMObj.GetObjectFromList<RectTransform>(6).gameObject.activeInHierarchy)
                {
        ...
        private static bool TitleScreenUI_OnWorkshopBrowserButtonClicked_Prefix(TitleScreenUI __instance)
        {
            ...
            V3.Gameplay.ArenaController.SetRootAndLogoVisible(false);
    ...
    public class OverhaulPatches
    {
        ...
        {
            return V3.Gameplay.AdvancedCameraController.GetInstance<AdvancedCameraController>().AllowCameraAnimatorAndMoverEnabled();
        }
        ...
        {
            V3.Base.V3_MainModController.CallEvent("cinematicCamera.Off", null);
        }
        ...
        {
            V3.Base.V3_MainModController.CallEvent("cinematicCamera.On", null);
        }
        ...
        {
            V3.HUD.SceneTransitionController.GoToMainMenu();
            return false;
        }
        ...
        {
            V3.Base.V3_MainModController.CallEvent("onPlayerSet", new object[]
            {
                player.GetRobotInfo(),
        ...
        {
            V3.Base.V3_MainModController.CallEvent("firstPersonMover.OnDestroy", new object[]
            {
        ...
        {
            if (CloneDroneOverhaul.V3.Graphics.CameraRollController.IsUIHidden)
            {
                __result = true;
            }
        }
        ...
        {
            V3.Base.V3_MainModController.CallEvent("onPlayerJoined", new object[]
            {
        ...
        public static void ExplodeWhenCut_onBodyPartDamaged_Prefix(ExplodeWhenCut __instance)
        {
            if (__instance != null && !__instance.GetPrivateField<bool>("_hasExploded") && __instance.ExplosionSpawnPoint != null)
            {
                ...
                RobotShortInformation robotInfo = V3.Gameplay.GameStatisticsController.GameStatistics.PlayerRobotInformation;
                if (!robotInfo.IsNull)
                {
        ...
        {
            OverhaulGraphicsController.PatchLight(__instance.PointLight, __instance.UseShadows, false);
        }
        ...
        {
            __result = ObjectSpawner.PlaceObject(objectPlacedLevelObjectEntry, levelRoot);
            return false;
        }
