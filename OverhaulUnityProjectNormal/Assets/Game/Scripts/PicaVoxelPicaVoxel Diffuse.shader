		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    vs_TEXCOORD3 = u_xlat18 * unity_FogParams.z + unity_FogParams.w;
					    u_xlat1.x = dot(in_NORMAL0.xyz, unity_WorldToObject[0].xyz);
					    u_xlat1.y = dot(in_NORMAL0.xyz, unity_WorldToObject[1].xyz);
					    u_xlat1.z = dot(in_NORMAL0.xyz, unity_WorldToObject[2].xyz);
					    u_xlat18 = dot(u_xlat1.xyz, u_xlat1.xyz);
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0.xyz = vs_COLOR0.xyz * _Tint.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = max(u_xlat9, 0.0);
					    u_xlat0.xyz = u_xlat0.xyz * u_xlat1.xyz;
					    u_xlat1.x = vs_TEXCOORD3 / _ProjectionParams.y;
		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    SV_Target0.xyz = vs_COLOR0.xyz * _Tint.xyz;
					    SV_Target0.w = 1.0;
