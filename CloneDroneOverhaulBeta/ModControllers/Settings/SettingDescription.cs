...
namespace CDOverhaul
{
    public class SettingDescription
    {
        ...
        public SettingDescription(in string desc, in string img43fileName = null, in string img169fileName = null)
        {
            ...
            {
                Image_4_3 = OverhaulUtilities.TextureAndMaterialUtils.FastSpriteCreate(OverhaulUtilities.TextureAndMaterialUtils.LoadTexture(OverhaulBase.Core.ModFolder + "Assets/Settings/" + img43fileName));
                return;
            }
            if (!string.IsNullOrEmpty(img169fileName))
            {
                Image_16_9 = OverhaulUtilities.TextureAndMaterialUtils.FastSpriteCreate(OverhaulUtilities.TextureAndMaterialUtils.LoadTexture(OverhaulBase.Core.ModFolder + "Assets/Settings/" + img169fileName));
            }
        }
    }
}
